...
{
    #region _VARIABLES_
    public int recepcion = 0;
    public string[] output;
    public string[] dataDCM;
    public string[] dataDCM_L;
    public string[] dataDCM_R;
    public string[] valuesDCM_L;
    public string[] valuesDCM_R;

    public Single[,] Rcal_L = new Single[3, 3];
    public Single[,] Rs_L = new Single[3, 3];
    public Single[,] RT_L = new Single[3, 3];
    public Single[,] Rcal_R = new Single[3, 3];
    public Single[,] Rs_R = new Single[3, 3];
    public Single[,] RT_R = new Single[3, 3];
    public Single[,] Acc = new Single[1, 3];

    public float moduleAcc;
    public Quaternion quat;
    public Single alfa_L;
    public Single alfa_R;

    public Single gamma_L;
    public Single gamma_R;
    public bool first_time_L = true;
    public bool DCMRecibido_L = false;
    public bool first_time_R = true;
    public bool DCMRecibido_R = false;
    ...
    public void OnMessageArrived(string msg)
    {
        if (long_pierna_get)
        {
            EMGParams data = JsonUtility.FromJson<EMGParams>(msg);
        ...
        else
        {
            EMGParams data = JsonUtility.FromJson<EMGParams>(msg);
            //t_data_received.text = data.ShowParams();
            StepController.instance.longitud_pierna = data.leg;
